      ...
      <div className={styles.faq_content}>
        ...
        <div className={styles.faq_item}>
          ...
          <p>
            ...
            reception desk or check our website for the list of accepted
            insurance providers.
          </p>
        </div>
        <div className={styles.faq_item}>
          ...
          <p>
            We accept cash, credit/debit cards, and mobile payment methods such
            as Apple Pay and Google Pay. We also accept payment through most
