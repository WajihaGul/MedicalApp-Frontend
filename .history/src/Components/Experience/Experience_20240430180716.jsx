    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.story}>
          Drawing upon a wealth of over 25 years of collective experience in the
          healthcare sector, our team brings unparalleled expertise to the
          ...
          platforms tailored to meet the unique needs of medical professionals,
