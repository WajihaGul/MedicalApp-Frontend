  ...
  return (
    <Carousel>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2016/8/Pharmacist_shutterstock_259613888.jpghttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyVdeqs4K4BgrI5vswEV9uru6dMuOutmwJWQ&s"
          alt="Third slide"
        />
        <Carousel.Caption>
