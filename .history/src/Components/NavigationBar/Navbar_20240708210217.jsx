...
const Navbar = ({ isLoggedIn, storedEmail, handleLogin, handleLogout, handleProfileView }) => {
    ...
    <nav className={`navbar navbar-expand-lg ${styles.container}`}>
      ...
      <div className={`collapse navbar-collapse ${styles.navLinks}`} id="navbarNav">
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item">
            <Link className={`nav-link ${styles.navLinksColor}`} to="/doctors">
              Doctors
            </Link>
          </li>
          <li className="nav-item">
            <Link className={`nav-link ${styles.navLinksColor}`} to="/search-medicine">
              Pharmacy
            </Link>
          </li>
          <li className="nav-item">
            <Link className={`nav-link ${styles.navLinksColor}`} to="/contact">
              Contact Us
            </Link>
          </li>
          {isLoggedIn ? (
            ...
            <Row className="align-items-center">
              ...
              <GoogleLogin
                onSuccess={(credentialResponse) => {
                  ...
                  setShowLoginModal(false); // Close the login modal on success
                  setShowRegisterModal(false); // Close the register modal on success
