...
const Accomplishments = () => {
  const [animate540, setAnimate540] = useState(false);
  const [animate899, setAnimate899] = useState(false);
    ...
    <div className={styles.container}>
      <div
        className={`${styles.column1} ${
          animate540 && styles.explanationiAnimation
        }`}
      >
        <img
          className="cols_img"
      ...
      <div
        className={`${styles.column1} ${
          animate899 && styles.explanationiAnimation
        }`}
      >
        <img
          className="cols_img"
        ...
        <p className={styles.explanationiii}>
          Benefit from our extensive expertise in resolving medical challenges,
          offering tailored solutions that prioritize patient well-being.
        </p>
      </div>

      <div
        className={`${styles.column3} ${
          animate100 && styles.explanationiAnimation
        }`}
      >
        <img
          className="cols_img"
